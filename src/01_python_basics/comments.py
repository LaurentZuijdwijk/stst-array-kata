...
# but you have to prepend every line with the # symbol. This can be
# done easily by selecting your code and hitting ctrl key + "/" key.
...
module functions called docstrings. 
Running the following command: help(yourfunction)
will display the docstrings of your functions so be aware that
only the comments you want gets displayed.
